...
<title>{{TITLE}} Faucet</title>
<meta name="description" content="Cryptocurrency faucet script">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-122596044-1"></script>
<script>
...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="#page-top">{{TITLE}}</a> </div>
    
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#about" class="page-scroll">About</a></li>
        <li><a href="#stats" class="page-scroll">Stats</a></li>
        <li><a href="#claim" class="page-scroll">Faucet Claims</a></li> 
        <li><a href="#roots" class="page-scroll">Roots</a></li>       
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
			  <img src="../img/BITG-LOGO.png" alt="" width="175" height="235">
            <h1>{{TITLE}} Faucet</h1>
            <p>Leaking BITG since July 19, 2018</p>
    ...
    <div class="row">
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          <h2>More about <span>{{TITLE}}</span></h2>
          <hr>
          <p>Bitcoin Green (BITG) is founded on 'The Green Protocol,' which utilizes a highly efficient proof-of-stake consensus algorithm that solves many of Bitcoin’s 
sustainability and scalability problems. Furthermore, Bitcoin Green can be mined on any computer or laptop without specialized equipment.</p>
          <p>Bitcoin Green, the organization, aims to shed light on a number of critical issues facing proof-of-work based blockchains and raise public awareness for the 
environmental and economic problems arising from such issues</p>
			<h3><b> <a href="https://savebitcoin.io">SaveBitcoin.io </a></b></h3></br>
		 
          <a href="#claim" class="btn btn-custom btn-lg page-scroll">Faucet Claims</a> </div>
      </div>
      <div class="col-xs-12 col-md-3">
        <div class="about-media"> <a href="https://nodehost.online/new_user/73278a4a86960eeb576a8fd4c9ec6997"><img src="../img/nodehost.png" alt=" "> </a> </div>
        <div class="about-desc">
          <a href="https://nodehost.online/new_user/73278a4a86960eeb576a8fd4c9ec6997"><h3>Learn More</h3></a>
          <p>One of NodeHost’s key goals is to make launching masternodes a seamless and easy process. With that in mind, they have made launching masternodes as easy as clicking a button.  </p>
        </div>
      </div>
      <div class="col-xs-12 col-md-3">
...
<div id="stats">
  <div class="container">
    <div class="section-title text-center center">
      <h2>Faucet Stats</h2>
      <hr>
		{{TITLE}} Value: USD <b> ${{USD_VALUE}}</b> | BTC <b></b>{{BTC_VALUE}}</b></br></br>

        Already paid: <b>{{TOTAL_PAYOUT}}</b> with <b>{{TOTAL_PROMO_PAYOUTS}}</b> promo on <b>{{NUMBER_OF_PAYOUTS}}</b> payouts.<br/><br/>

        How many payments are currently staged: <b>{{STAGED_PAYMENT_COUNT}}</b> payments.<br/>

        Total BITG staged to be sent : <b>{{SUM_STAGED_PAYMENTS}}</b> <br/>
...
<div id="contact" class="text-center">
  <div class="container">
    <div class="section-title text-center">
      <h2>Contact Us</h2>
      <hr>
      <p>Im frequently available on the Bitcoin Green Discord Server</p>
    </div>
    <div class="col-md-10 col-md-offset-1 contact-info col-lg-offset-0 col-lg-12">
<div class="col-md-4 col-lg-offset-4 col-lg-4">
	<a href="https://discord.gg/BHK6RXy"><h3>Join Discord</h3></a>
        <a href="https://discord.gg/BHK6RXy"><img src="../img/joindiscord.png" style='height: 25%; width: 25%; object-fit: contain'></a>
